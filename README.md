...
| SparseMix-2 | Registered and submitted; both-state confirmation pending | [Prospective protocol and run record](wiki/experiments/Sparse-Mixing-V2-Preregistration.md) |
