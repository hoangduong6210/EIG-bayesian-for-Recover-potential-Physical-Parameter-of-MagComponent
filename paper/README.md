...
The conference snapshot is retained for archival comparison. Its five-seed
numbers must be read through its
[`claim-to-evidence register`](conference_snapshot/CLAIMS_EVIDENCE.md), not
mixed with the current 30-seed benchmark.
