...
\hypersetup{
  ...
  pdfsubject={Bayesian calibration and optimal experimental design for magnetic-core models},
  pdfkeywords={Bayesian calibration, magnetic core, core loss, complex permeability, optimal experimental design, expected information gain}
}
...
permeability model. These results support uncertainty-aware calibration and
model-conditional measurement planning within the tested models and operating
ranges; they do not establish an optimal laboratory plan.
\end{abstract}
\par\smallskip
\noindent\textit{Keywords:} Bayesian calibration; magnetic core; core loss; complex permeability; optimal experimental design; expected information gain.
\vspace{8pt}
...
on the selected model, observations, and prior. It also supports Bayesian
optimal experimental design: a candidate measurement can be ranked by its
expected reduction of posterior uncertainty~\cite{chaloner1995,ryan2016}.
...
threshold is recorded as a failure at the maximum budget.
