...
- A joint Bayesian calibration pipeline for three Steinmetz and three
  ...
  checks. [E1](evidence/Evidence-Sources.md#e1)
- A paired 30-seed benchmark in which every policy receives the same
  ...
  isothermal designs. [E1](evidence/Evidence-Sources.md#e1)
- An eight-policy comparison separating raw information gain from modeled-
  ...
  D-optimal comparators. [E4](evidence/Evidence-Sources.md#e4)
...
- A public evidence chain from registered configurations and sanitized task
  ...
  [E8](evidence/Evidence-Sources.md#e8), [E16](evidence/Evidence-Sources.md#e16)
...
![Study structure separating recovery, acquisition comparison, and measured-data adequacy.](assets/study-workflow.png)
...
departures. [Model-mismatch evidence E16](evidence/Evidence-Sources.md#e16)
...
materials. [E16](evidence/Evidence-Sources.md#e16)

![MM-3 false-confidence counts and paired strong-comparator contrasts. Positive differences favor EIG.](assets/model-mismatch-v3.png)
...
- truth-error, latent-holdout and paired-policy outcomes for the three locked
  synthetic mismatch families [E16](evidence/Evidence-Sources.md#e16).
...
and its 120-record public audit asset. [Model-mismatch evidence E16](evidence/Evidence-Sources.md#e16)
