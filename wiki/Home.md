...
| Model-mismatch campaign MM-1 | Preregistered; no confirmatory outcome admitted | [MM-1 protocol](experiments/Model-Mismatch-Preregistration.md) |
| Gate-aligned utility and simulation-based calibration | Deferred until MM-1 completes | [Decision 0001](decisions/0001-gate-aligned-objective.md) |
