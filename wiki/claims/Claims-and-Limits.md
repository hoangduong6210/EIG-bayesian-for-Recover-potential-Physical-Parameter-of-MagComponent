...
| Claim | Scope | Source |
|---|---|---|
| Prior-predictive matched-model recovery exercises the six-coordinate inference pipeline without oracle centering | Five synthetic recovery seeds | [E2](../evidence/Evidence-Sources.md#e2) |
| Raw EIG uses fewer measurements than the deterministic fixed channel-balanced traversal | 30 paired seeds; local two-target gate | [E4](../evidence/Evidence-Sources.md#e4) |
| Raw EIG ties predictive variance and Laplace D-optimality on measurement count | Four preregistered direct contrasts; 30 paired seeds | [E4](../evidence/Evidence-Sources.md#e4) |
...
- EIG superiority over strong comparators.
- Reduction in measured laboratory time or financial cost.
...
Use “matched-model synthetic,” “model-conditional,” “local two-target
precision gate,” and “modeled cost” wherever those qualifiers affect a claim.
