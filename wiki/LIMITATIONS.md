...
6. Temperature dependence, structural model mismatch, multi-lot variability,
   and component-level validation remain future work.
7. The public projection is aggregate; deeper independent audit requires the
   verified production release or rerunning the declared campaign.
